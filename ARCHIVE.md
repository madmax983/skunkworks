...
- **babylonian-forecaster**: Terminal Chart Rot. Redundant with `babylonian-garden`. Documentation void. Grace period: 24h.
...
- **git-climber**: Specimen executed. Documentation void. Fragile stack (Bevy/Rapier). Skeletal. Moved to graveyard.
- **hertzian-shimmer**: Specimen executed. Documentation void. Fragile dependency (cpal). Redundant with `cymatic-ocean`. Moved to graveyard.
