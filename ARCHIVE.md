...
- **event-horizon**: Specimen condemned. Orphaned, undocumented, and fragile. Grace period: 24h.
...
## Executed
- **synaptic-choir**: Specimen executed. Terminal build failure (alsa-sys). Moved to graveyard.
