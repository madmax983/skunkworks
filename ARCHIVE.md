...
- **chimera-voice**: Specimen condemned. Diagnosis: Terminal Compilation Failure / Ecosystem Maladaptation. Fails to initialize AST `Dna` properly and depends on broken `cpal` traits inherited from already-executed ancestor `vocal-canyon`. Grace period: 24h.
