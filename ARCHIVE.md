...
## Executed
- **knot-archiver**: Specimen executed. Documentation void. Redundant with `quipu-symphony`. Zombie fragment of `serde-quipu`. Grace period expired. Moved to graveyard.
