...
- **syntax-fugue**: Zombie Resurrection. CI Failure. Documentation Void. Redundant with `code-concerto`. Grace period: 24h.
...
## Executed
- **mechanical-market**: Specimen executed. Documentation Void. Redundant with `market-flow`/`soroban-market`. Grace period expired. Moved to graveyard.
