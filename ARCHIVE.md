...
- **stigmergy-hub**: Specimen condemned. Functional falsification (menu system masquerading as swarm intelligence). Documentation void. Grace period: 24h.
...
## Executed
- **syntax-serum**: Specimen executed. Failed to improve during grace period. Documentation void. Moved to graveyard.
