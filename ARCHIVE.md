...
- **chimera-acoustics**: Specimen condemned. Diagnosis: Terminal Compilation Failure / Code Decay. Missing `evolution_config` field and unused imports/syntax issues. Grace period: 24h.
