...
- **hyper-neuron**: Specimen condemned. Diagnosis: Ecosystem Maladaptation. Panics via `XOpenDisplay()` in headless environments due to missing `--headless` bypass for macroquad. Grace period: 24h.


## ☠️ Executed
- **bio-transit**: Specimen executed. Diagnosis: Ecosystem Maladaptation (macroquad without headless bypass). Grace period expired. Moved to graveyard.
