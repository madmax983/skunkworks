...
- **beat-cortex**: Documentation void. Generic Reservoir Computing implementation. Redundant with `lattice-brain`/`hydro-brain`. Grace period: 24h.
...
## Executed
- **biotic-chaos**: Specimen executed. Documentation void. Generic CML implementation. Lacks persona alignment. Moved to graveyard.
