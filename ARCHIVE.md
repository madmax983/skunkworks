...
- **digital-retina**: Documentation void. Sketch rot. Skeletal implementation. Grace period: 24h.
...
## Executed
- **slime-train**: Specimen executed. Documentation void. Hardcoded geometry. Redundant with `myco-transit`. Moved to graveyard.
