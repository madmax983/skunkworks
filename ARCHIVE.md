...
- **lithosphere-termites**: Documentation Void / Skeletal Rot (Recidivist). Failed to improve after pardon. Grace period: 24h.
...
## Executed
- **neuro-crab**: Specimen executed. Diagnosis: Documentation Void / Skeletal Implementation. Grace period expired. Moved to graveyard.
