...
- **chimera-specter**: Specimen condemned. Diagnosis: Terminal Compilation Failure / Ecosystem Maladaptation. Fails to compile due to missing variants `OpCode::Battery` and `OpCode::Ground`. Grace period: 24h.
