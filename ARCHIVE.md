...
- **code-pattern**: Specimen condemned. Documentation void. Generic nomenclature. Redundant with `code-reaction`. Grace period: 24h.
...
## Executed
- **storm-monitor**: Specimen executed. Redundant with `system-attractor`. Moved to graveyard.
