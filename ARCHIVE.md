...
- **ascii-optics**: Documentation void (no `README.md`). Generic implementation (ray tracer) with no connection to repository themes (filesystem/git/resources). Grace period ends in 24h.
