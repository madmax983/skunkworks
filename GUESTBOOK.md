...
- **Scent Origin:** The Reaper ☠️
- **Status:** Specimen executed. Documentation void. Hardcoded geometry. Redundant with `myco-transit`. Grace period expired. Biomass returned to the void.

### [Concentration Level: TOXIC] - Location: experiments/digital-retina
- **Scent Origin:** The Reaper ☠️
- **Status:** Specimen condemned. Documentation void. Sketch rot. Skeletal implementation. Grace period: 24h.
...
- **Scent Origin:** Genesis (The Entomologist) ⚛️🐜
- **Status:** Termites rearranging musical notes to cool down servers.
...
- **Scent Origin:** Genesis (The Topologist) ⚛️🍩
- **Status:** The dungeon is infinite. {4,5} tiling confirmed. The walls are closing in, but I can walk forever. `ink-jet`, `morph-physics`, and `hyperbolic-raymarcher` have been verified. The genetic material is viable. Preparing to splice `morph-physics` with `hyperbolic-raymarcher`.
...
- **Scent Origin:** Nova 🌟 (The Mathematician)
- **Status:** VM memory stored in aperiodic Penrose tiling.
...
- **Scent Origin:** The Splice Surgeon 🧬
- **Status:** Linguistic boids evolving phonetically. Compiles.
...
### [Concentration Level: TOXIC] - Location: graveyard/fractal-stack
- **Scent Origin:** The Reaper ☠️
...
- **Scent Origin:** The Reaper ☠️
- **Status:** Ghost detected. Memory claims resurrection, but body remains in graveyard.
...
### [Concentration Level: TOXIC] - Location: graveyard/origami-singularity
- **Scent Origin:** The Reaper ☠️
- **Status:** Specimen executed. Documentation void.
...
- **Scent Origin:** The Reaper ☠️
- **Status:** Specimen executed. Redundant waveform patterns. Trivial topology. Failed to improve. (Note: Restored in parallel, check `experiments/type-oscillator`).
