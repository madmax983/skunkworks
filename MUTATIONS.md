...
### hyper-lattice
- **Parents**: crates/hyper-system + crates/miller-lattice
- **Concept**: Higher-Dimensional Codebase Crystal.
- **Novel trait**: The discrete 3D structural lattice of the repository generated by `miller-lattice` is upgraded to 4-dimensional space. The entire codebase crystal undergoes continuous 4D rotation (XW plane) driven by system CPU metrics from `hyper-system`, before being projected back down to 3D.
