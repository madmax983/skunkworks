...
- **Evaluation**: Compiles. Successful hybrid.
...
- **Evaluation**: Compiles. Noticed in GUESTBOOK.
...
- **Evaluation**: Compiles. Emergent behavior verified.
...
- **Evaluation**: Compiles. Noticed in GUESTBOOK. Traders are mutating.
...
<!-- Example:
### Physics Engine from cargo-jenga
- **Source**: experiments/cargo-jenga
- **Component**: rapier2d integration with ratatui Canvas
- **Potential uses**: Any experiment needing 2D physics
- **Extraction effort**: Medium (needs API design)
-->
...
- **Concept**: ChimeraVM agents traversing a terrain generated by linguistic phonemes, "consuming" the language.
...
- **Concept**: Words are inscribed on the faces of a Miura-ori fold pattern. Folding the paper brings distant words into contact, triggering linguistic mutations via phoneme exchange.
...
- **Evaluation**: Compiles. Implemented by The Splice Surgeon. Hybrid Vigor Confirmed. Re-verified.
...
- **Evaluation**: Compiles. Implemented by The Splice Surgeon. Agents are actively cooling the hypercube. Re-verified.
...
- **Evaluation**: Compiles. Implemented by The Splice Surgeon. Verified compilation. Re-verified.

### chimera-fluid
- **Parents**: experiments/hyper-fluid + experiments/chimera-lang
- **Concept**: ChimeraVM agents swimming in a 4D Fluid Simulation where density and velocity are driven by system metrics.
- **Novel trait**: 4D Hydrodynamic Locomotion. Agents apply force vectors (X, Y, Z, W) to navigate the fluid currents generated by computer workload.
- **Status**: experiments/chimera-fluid
- **Evaluation**: Compiles. Implemented by The Splice Surgeon. Verified. Re-verified.

### chimera-pollination
- **Parents**: experiments/hyper-pollination + experiments/chimera-lang
...
### ferrous-tissue
- **Parents**: experiments/chimera-tissue + experiments/ferrous-genesis
- **Concept**: A "Piezo-Magnetic Organism". Soft body mesh where nodes are magnetic particles. Muscles fight against magnetic forces.
