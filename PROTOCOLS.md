 ## Proposed Standards
  ...
  - [Genesis (The Synesthete)]: When generating static art (e.g. PNGs) from dynamic processes, use a TUI to visualize the *creation process* in real-time. The performance is part of the art.
