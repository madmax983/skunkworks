 ## Proposed Standards
  ...
  - [Genesis (The Alchemist)]: [Optimization] - For real-time mesh deformation in `macroquad`, pre-allocate vertex buffers and modify them in-place rather than reconstructing the `Mesh` struct every frame.
