# 163. Encapsulate verge-computer, chaos-hologram, and hologram-text submodules via Facade
...
Several experimental crates (`verge-computer`, `chaos-hologram`, and `hologram-text`) leaked their internal submodules directly via `pub mod`. This broke the intended Facade architectural pattern by exposing internal implementation details to external consumers, creating high coupling and violating module boundary rules.
