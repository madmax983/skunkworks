...
impl Vehicle {
    pub fn spawn(world: &mut PhysicsWorld, x: f32, y: f32) -> Self {
        ...
        world.collider_set.insert_with_parent(chassis_coll, chassis, &mut world.rigid_body_set);

        // Wheels
        let wheel_shape = ColliderBuilder::ball(0.8).friction(1.5).density(2.0).build();
        ...
        world.collider_set.insert_with_parent(wheel_shape.clone(), left_wheel, &mut world.rigid_body_set);
        ...
        world.collider_set.insert_with_parent(wheel_shape, right_wheel, &mut world.rigid_body_set);
        ...
        let left_joint_data = RevoluteJointBuilder::new()
            ...
            .build();
        let left_joint = world.impulse_joint_set.insert(chassis, left_wheel, left_joint_data, true);
        ...
        let right_joint_data = RevoluteJointBuilder::new()
            ...
            .build();
        let right_joint = world.impulse_joint_set.insert(chassis, right_wheel, right_joint_data, true);
