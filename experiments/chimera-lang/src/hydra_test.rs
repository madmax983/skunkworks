...
mod tests {
    ...
    fn test_hydra_pump() {
        ...
        assert!(vm.moisture_grid[5][5] >= 40, "Pump should add moisture (approx 50)");
    }
    ...
    fn test_hydra_flow() {
        ...
        assert_eq!(vm.wind_grid[5][5], (0, 0), "Wind should move away from source");
        ...
        assert!(vm.moisture_grid[5][10] > 0, "Moisture should advect East to 5,10");
    ...
    fn test_hydra_wall() {
        ...
        assert!(vm.moisture_grid[5][5] > 0, "Moisture should be reflected/stay");
    }
}
