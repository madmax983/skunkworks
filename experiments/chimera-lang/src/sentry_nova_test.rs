...
mod tests {
    ...
    fn test_migrate_wrap() {
        ...
        let genes = vec![
            ...
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(15)] }, // dx
        ...
        let genes2 = vec![
            ...
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(-9)] }, // dx
            Gene { op: OpCode::Migrate, args: vec![] },
        ];
    ...
    fn test_cas9_cut_boundary() {
        ...
        let genes = vec![
            ...
            Gene { op: OpCode::Cas9Cut, args: vec![] },
        ];
        let mut vm = ChimeraVM::new(make_dna(genes));
    ...
    fn test_ligase_boundary() {
        ...
        let s0 = Strand {
            genes: vec![
                ...
                Gene { op: OpCode::Ligase, args: vec![] },
            ],
        };
        ...
        let dna2 = Dna { helix: Helix { strands: vec![s0_2, s1_2] } };
    ...
    fn test_spore_branching() {
        ...
        let genes = vec![
            ...
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(100)] }, // 1
            Gene { op: OpCode::Sporulate, args: vec![] }, // 2
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // 3: ID 0
            Gene { op: OpCode::Germinate, args: vec![] }, // 4
        ];
        let mut vm = ChimeraVM::new(make_dna(genes));
        vm.energy = 1000;
    ...
    fn test_integrase_append() {
        ...
        let genes = vec![
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] },
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(5)] }, // Index 5 (append)
            Gene { op: OpCode::Push, args: vec![Nucleotide::String("push".to_string())] },
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(99)] },
            Gene { op: OpCode::Integrase, args: vec![] },
        ];
        let mut vm = ChimeraVM::new(make_dna(genes));

        for _ in 0..5 { vm.step(); } // Execute all
    ...
    fn test_excision_last() {
        ...
        let genes = vec![
            ...
            Gene { op: OpCode::Excision, args: vec![] },
        ];
        let mut vm = ChimeraVM::new(make_dna(genes));
