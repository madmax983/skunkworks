...
pub fn exec_nova_op(vm: &mut ChimeraVM, op: OpCode, args: &[Nucleotide]) -> Option<(usize, usize)> {
    match op {
        ...
        OpCode::EgregoreLink => super::nova_egregore::exec_egregore_op(vm, op, args),
        OpCode::Lucid => {
            // stack: amount
            if let Some(val) = vm.stack.pop() {
        ...
        OpCode::Sacrifice => super::nova_egregore::exec_egregore_op(vm, op, args),
        ...
        OpCode::Knot | OpCode::Unknot | OpCode::Cord | OpCode::ReadCord | OpCode::Tangle => {
            super::nova_quipu::exec_quipu_op(vm, op, args)
        }
        OpCode::Offer
        | OpCode::Buy
        | OpCode::Invest
        ...
        OpCode::RetinaDraw | OpCode::RetinaClear | OpCode::RetinaSize => {
            super::nova_retina::exec_retina_op(vm, op, args)
        }
        OpCode::QuantumJump => {
            let s_idx = vm.ip.0;
