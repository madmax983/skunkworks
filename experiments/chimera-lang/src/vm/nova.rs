...
use super::{nova_bestiary, ChimeraVM, ChromaCell, Value};
...
pub fn exec_nova_op(vm: &mut ChimeraVM, op: OpCode, args: &[Nucleotide]) -> Option<(usize, usize)> {
    match op {
        ...
        | OpCode::EgregoreSummon => super::nova_egregore::exec_egregore_op(vm, op, args),
        #[cfg(feature = "nova")]
        ...
        | OpCode::Divest
        | OpCode::Balance
        | OpCode::Ticker => super::nova_market::exec_market_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::TimeWarp => {
        ...
        | OpCode::Terraform
        | OpCode::SenseBiome => super::nova_physics::exec_physics_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::Alchemy => {
            let (cy, cx) = vm.context_loc;
        ...
        | OpCode::Apoptosis
        | OpCode::Integrase
        | OpCode::Excision => super::nova_genetics::exec_genetics_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::Secrete => {
        ...
        #[cfg(feature = "nova")]
        OpCode::Detox => super::nova_physics::exec_physics_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::WRead => {
            let (cy, cx) = vm.context_loc;
        ...
        OpCode::Gravitate
        | OpCode::Lumine
        | OpCode::SenseLight => super::nova_physics::exec_physics_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::Dream => {
            // stack: ticks, strand_idx (bottom)
            if vm.stack.len() >= 2 {
        ...
        #[cfg(feature = "nova")]
        OpCode::Irradiate
        | OpCode::SenseMutagen => super::nova_physics::exec_physics_op(vm, op, args),
        #[cfg(feature = "nova")]
        OpCode::Devour => {
            let (cy, cx) = vm.context_loc;
