...
impl Biome {
    /// Calculates the inertia factor for diffusion.
    ...
    /// Calculates the decay percentage per tick (0-100).
    ...
    /// Provides the energy cost modifier for operations in this biome.
    /// 1.0 is base cost.
    ...
    /// Yields the probability of spontaneous mutation (0.0 - 1.0).
    ...
    /// Calculates the magic amplification factor.
    ...
    /// Provides the RGB color for TUI visualization.
