...
pub fn apply_elektra_runes(
    ...
    voltage_grid: &mut [Vec<f32>],
    resistance_grid: &mut [Vec<f32>],
    capacitance_grid: &mut [Vec<f32>],
    energy: &mut i64,
...
pub fn apply_elektra_runes(
    ...
    _voltage_grid: &mut [Vec<f32>],
    _resistance_grid: &mut [Vec<f32>],
    _capacitance_grid: &mut [Vec<f32>],
    _energy: &mut i64,
