...
mod tests {
    ...
    fn test_axon_propagation() {
        let genes = vec![
            ...
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // x_src
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // y_src
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // x_tgt
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(1)] }, // y_tgt
            Gene { op: OpCode::Axon, args: vec![] },

            // 4. Stimulate Source (0,0)
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(200)] }, // amount
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // y
            Gene { op: OpCode::Push, args: vec![Nucleotide::Number(0)] }, // x
            Gene { op: OpCode::Stimulate, args: vec![] },
        ];
        ...
        assert!(vm.biophysics_synapses.contains_key(&(0, 0)), "Synapse map missing (0,0)");
