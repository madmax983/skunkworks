...
fn test_conceive() {
    let dna_genes = vec![
        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(100)] }, // Fid
        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(100)] }, // Vir
        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(2)] },   // Len
        Gene { op: OpCode::Conceive, args: vec![] },
        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(99)] }, // Target for capture
    ];
...
fn test_shibboleth() {
    let genes = vec![
        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(5)] }, // Initial value

        Gene { op: OpCode::Push, args: vec![Nucleotide::String("push".to_string())] }, // From
        Gene { op: OpCode::Push, args: vec![Nucleotide::String("drop".to_string())] }, // To
        Gene { op: OpCode::Shibboleth, args: vec![] },

        Gene { op: OpCode::Push, args: vec![Nucleotide::Number(10)] }, // Should act as Drop
    ];
