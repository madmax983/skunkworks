...
pub fn spawn_rotor(
    ...
    let rotor = commands.spawn((
        ...
        Damping { linear_damping: 0.0, angular_damping: 1.0 }, // Damping to stabilize
        // Visuals
        ShapeBundle {
...
pub fn spawn_pawl(
    ...
    // The Pawl Arm
    let pawl = commands.spawn((
        Name::new("Pawl"),
        Pawl,
        SpatialBundle::from_transform(Transform::from_translation((pivot_pos + Vec2::new(length/2.0, 0.0)).extend(0.0))),
        RigidBody::Dynamic,
