...
pub trait CipherReveal {
    fn reveal(&mut self, x: u32, y: u32, amount: f32);
    fn reveal_line(&mut self, x0: u32, y0: u32, x1: u32, y1: u32, amount: f32);
}

impl CipherReveal for Memory {
    fn reveal(&mut self, x: u32, y: u32, amount: f32) {
