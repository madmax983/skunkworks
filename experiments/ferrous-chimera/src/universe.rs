...
impl Universe {
    fn world_to_grid(x: f64, y: f64) -> (i32, i32) {
    ...
    pub fn step(&mut self, dt: f64) {
        ...
        for agent in &mut self.agents {
            ...
            let (gx, gy) = Self::world_to_grid(agent.body.pos.x, agent.body.pos.y);
            ...
            // Apply force
            agent.body.acc += force * 50.0; // Scale up force
            ...
            agent.body.apply_wrap_around(-100.0, 100.0);
