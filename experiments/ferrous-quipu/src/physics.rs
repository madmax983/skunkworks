...
impl Universe {
    ...
    pub fn step(&mut self, dt: f32) {
        ...
        // Constants
        let g_edge = 2000.0; // Stiffer springs? No, standard.
        ...
        for &(i, j) in &self.edges {
            ...
            // Hooke's law-ish but with gravity
            let force = (g_edge * self.bodies[i].mass * self.bodies[j].mass) / dist_sq;
            // Actually ferrous-graph uses inverse square attraction for edges? That's weird for springs.
            // Usually springs are k * displacement.
            // But let's stick to the parent's physics for "Genetic Lineage" reasons,
            // maybe tweak g_edge if needed.
            // Inverse square attraction means they want to be close but not *too* close?
            // Actually if dist -> 0, force -> inf.
        ...
        // 3. Gravity, Integration, and Magnetism
