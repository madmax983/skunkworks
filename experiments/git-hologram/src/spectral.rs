...
impl SpectralField {
    ...
    pub fn compute_potential(&mut self, resonance_dist: f64) {
        ...
        for y in 0..self.height {
            for x in 0..self.width {
                ...
                // Peaks around resonance_dist distance.

                let factor = (-((dist - resonance_dist).powi(2) / 50.0)).exp(); // Gaussian centered at resonance_dist
