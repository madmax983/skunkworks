            ...
            if idx < self.grid.len() {
                ...
                if agent.carrying {
                    ...
                    if matches!(cell_material, Material::Empty) {
                        ...
                        let mut neighbors = 0;
                        if nx > 0 && matches!(self.grid[idx - 1].material, Material::Rock) {
                            neighbors += 1;
                        }
                        if nx < WIDTH - 1 && matches!(self.grid[idx + 1].material, Material::Rock) {
                            neighbors += 1;
                        }
                        if ny > 0 && matches!(self.grid[idx - WIDTH].material, Material::Rock) {
                            neighbors += 1;
                        }
                        if ny < HEIGHT - 1
                            && matches!(self.grid[idx + WIDTH].material, Material::Rock)
                        {
                            neighbors += 1;
                        }
