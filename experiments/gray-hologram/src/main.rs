//! # Holographic Reaction-Diffusion (gray-hologram)
//!
//! A hybrid experiment combining Gray-Scott reaction-diffusion with FFT-based holographic projection.
//!
//! ## Lineage
//! - **Parent A**: `crates/gray-scott` (Reaction-Diffusion Simulation)
//! - **Parent B**: `experiments/hologram-text` (FFT Holographic Rendering)
