...
async fn main() {
    ...
    loop {
        ...
        // Parallel update is tricky with particles unless we use chunks.
        // For 2000 particles, sequential is fine.
        ...
        for p in &mut particles {
            ...
            // Bounds check handled by get() returning 0.0
        ...
        for p in &particles {
            ...
            draw_sphere(pos_3d, 0.05, None, color);
        }
