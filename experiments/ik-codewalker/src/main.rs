...
fn setup_scene(mut commands: Commands) {
    ...
    let target_entity = commands.spawn((
        ShapeBundle {
            ...
            spatial: SpatialBundle::from_transform(Transform::from_translation(Vec3::new(100.0, 100.0, 10.0))),
            ..default()
        },
    ...
    let effector = commands.spawn((
        ShapeBundle {
             path: GeometryBuilder::build_as(&shapes::RegularPolygon { // Triangle claw
                sides: 3,
