    ...
    loop {
        tui.terminal.draw(|f| {
            ...
            let canvas = Canvas::default()
                .block(Block::default().borders(Borders::ALL).title(" Locus Fluid "))
            ...
            let stats = Paragraph::new(format!(
                "Boids: {} | Magnets: {} | [WASD] Move Magnet | [Space] Toggle | [Enter] Add Magnet | [Q] Quit",
        ...
        if last_tick.elapsed() >= tick_rate {
            universe.update(0.05); // Fixed time step, keeping as f64
