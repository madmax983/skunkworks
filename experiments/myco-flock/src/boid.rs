...
pub struct Dna {
    ...
    pub pheromone_attraction_weight: f64,
    pub pheromone_deposit_amount: f64,
    pub color: Color,
...
impl Dna {
    pub fn random() -> Self {
        ...
        Self {
            ...
            pheromone_attraction_weight: rng.gen_range(0.5..1.5), // New trait
            pheromone_deposit_amount: rng.gen_range(5.0..15.0),   // New trait
