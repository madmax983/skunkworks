...
use thermo_defense::grid::{self, WIDTH, HEIGHT, Material};
...
async fn main() {
    ...
    loop {
        ...
        for agent in &world.agents {
            ...
            if x < WIDTH as u32 && y < HEIGHT as u32 {
                let color = match agent.kind {
                    AgentType::Termite => if agent.carrying { YELLOW } else { BLUE },
        ...
        draw_text("Left: Spawn Server | Right: Spawn Wall | T: Termites | L: Locusts", 10.0, 20.0, 20.0, WHITE);
