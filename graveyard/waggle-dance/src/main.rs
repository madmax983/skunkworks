...
async fn main() {
    ...
    loop {
        ...
        // Draw Hive
        draw_circle(
            world.hive_position.x,
            world.hive_position.y,
            world.hive_radius,
        ...
        draw_text(
            "Right Click: Increase Quality Source 0",
            10.0,
            70.0,
            20.0,
            LIGHTGRAY,
        ...
        // Stats
        let scouting_count = world
            .bees
            .iter()
            .filter(|b| b.state == BeeState::Scouting)
            .count();
        let foraging_count = world
            .bees
            .iter()
            .filter(|b| b.state == BeeState::Foraging)
            .count();
        let dancing_count = world
            .bees
            .iter()
        ...
        draw_text(
            &format!("Scouting: {}", scouting_count),
            screen_width() - 150.0,
            20.0,
            20.0,
            WHITE,
        ...
        draw_text(
            &format!("Foraging: {}", foraging_count),
            screen_width() - 150.0,
            40.0,
            20.0,
            ORANGE,
